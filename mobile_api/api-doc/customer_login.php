                        ...
                        <div class="col-md-12">
                            <div class="card table-big-boy">
                                <div class="card-header ">
                                    <h4 class="card-title">Customer Login API <b class="alert alert-primary">POST</b></h4>
                                    <br />
                                </div>
                                <div class="card-body p-3">
                                   ...
                                   <hr>
                                   <b class="alert alert-primary">POST</b> <span class="text-red">login_type </span> value should be <b>customer</b>
                                   <hr>
                                   <b>API Results</b>
                                   <hr>
                                   <p>
                                   ...
                                   <p>
                                       { <br>
                                          &nbsp;&nbsp;&nbsp;  
                                          <span class="text-orange">"login"</span>: <span class="text-navy">"customer",</span> <br>
                                          &nbsp;&nbsp;&nbsp;  
