                        ...
                        <div class="col-md-12">
                            <div class="card table-big-boy">
                                <div class="card-header ">
                                    <h4 class="card-title">City Area API <b class="alert alert-danger">GET</b></h4>
                                    <br />
                                </div>
                                <div class="card-body p-3">
                                   <b id="get_base_url">Base URL</b>/city_area.php
                                   <hr>
                                   <b class="alert alert-danger">GET</b> <span class="text-navy">city_id</span> value should be in integer type <b class="text-red">1</b>
                                   <hr>
                                   <b>API Results</b>
                                   <hr>
                                   <p>
                                       [ <br>
                                          ...
                                          { <br>
                                            ...
                                            &nbsp;&nbsp;&nbsp;
                                            <span class="text-orange">"city_id"</span>: <span class="text-navy">"1",</span> <br>  
                                            &nbsp;&nbsp;&nbsp;
                                          ...
                                          { <br>
                                            ...
                                            &nbsp;&nbsp;&nbsp;
                                            <span class="text-orange">"city_id"</span>: <span class="text-navy">"2",</span> <br>  
                                            &nbsp;&nbsp;&nbsp;
                                            <span class="text-orange">"city"</span>: <span class="text-navy">"Lahore",</span> <br>
                                            &nbsp;&nbsp;&nbsp;
                                            <span class="text-orange">"city_area"</span>: <span class="text-navy">"Shabir Town",</span> <br>
