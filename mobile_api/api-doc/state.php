                        ...
                        <div class="col-md-12">
                            <div class="card table-big-boy">
                                <div class="card-header ">
                                    <h4 class="card-title">State API <b class="alert alert-danger">GET</b></h4>
                                    <br />
                                </div>
                                <div class="card-body p-3">
                                   <b id="get_base_url">Base URL</b>/state.php
                                   <hr>
                                   <b>API Results</b>
                                   <hr>
                                   <p>
                                       [ <br>
                                          ...
                                          { <br>
                                            ...
                                            &nbsp;&nbsp;&nbsp;
                                            <span class="text-orange">"state"</span>: <span class="text-navy">"Sindh",</span> <br>
