                        ...
                        <div class="col-md-12">
                            <div class="card table-big-boy">
                                <div class="card-header ">
                                    <h4 class="card-title">Menu, Category, Sub Category & Page no Wise Products API <b class="alert alert-danger">GET</b></h4>
                                    <br />
                                </div>
                                <div class="card-body p-3">
                                   <b id="get_base_url">Base URL</b>/products.php
                                   <hr>
                                   <b class="alert alert-danger">GET</b> <span class="text-navy">menu_id</span> value should be in integer type <b class="text-red">1</b>
                                   <hr> 
                                   <b class="alert alert-danger">GET</b> <span class="text-navy">category_id</span> value should be in integer type <b class="text-red">1</b>
                                   <hr> 
                                   <b class="alert alert-danger">GET</b> <span class="text-navy">sub_category_id</span> value should be in integer type <b class="text-red">1</b>
                                   <hr> 
